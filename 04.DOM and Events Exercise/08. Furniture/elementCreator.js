//Фабрика за елементи чрез подаване на необходими параметри създава абстрактно html проверките се изпълнява само с подаване на пропъртито понеже ако е празно ще подаде Falsy стойност.
